...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-black">
      <div className="mx-auto max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-12 items-stretch px-4 py-12">
        ...
        <div className="flex items-center justify-center">
          <div className="w-full max-w-md bg-white dark:bg-zinc-900 rounded-2xl shadow p-6 md:p-8">
            ...
            <h1 className="text-3xl font-bold text-blue-900 dark:text-blue-200 mb-6">Sign In</h1>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              <div>
                ...
                <div className="mt-2 text-sm">
                  <Link href="#" className="text-blue-700 hover:underline">Forgot email</Link>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <button type="button" className="inline-flex items-center justify-center gap-2 rounded-md border border-gray-300 dark:border-zinc-700 px-4 py-2 hover:bg-gray-50 dark:hover:bg-zinc-800">
                ...
                <button type="button" className="inline-flex items-center justify-center gap-2 rounded-md border border-gray-300 dark:border-zinc-700 px-4 py-2 hover:bg-gray-50 dark:hover:bg-zinc-800">
                  <span className="text-sm font-medium">Sign in with Intuit</span>
                </button>
              </div>
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">
                Need Help? <a className="text-blue-700 hover:underline" href="#">Visit our help center</a>
              </div>
            </form>
          </div>
        </div>
